...
/// when no GPU-direct path is available (DVP is a later pass).
struct DeckLinkCpuCapture final : score::gfx::interop::GpuDirectCaptureStrategy
{
  ...
  const char* name() const noexcept override { return "DeckLink-CPU"; }
